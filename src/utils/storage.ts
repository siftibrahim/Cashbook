...
export const INITIAL_PRODUCTS: Product[] = [
  {
    id: 'prod_minoxidil',
    name: 'কার্কল্যান্ড ৫% মিনক্সিডিল হেয়ার রিগ্রোথ সলিউশন',
    category: 'মেডিসিন',
    unit: 'বোতল',
    buyPrice: 1100,
    salePrice: 1450,
    ...
    description: 'আমেরিকান অরিজিনাল কার্কল্যান্ড সিগনেচার এক্সট্রা স্ট্রেংথ মিনক্সিডিল টপিক্যাল সলিউশন ৫%। চুল পড়া রোধ ও নতুন চুল গজাতে বিশ্বস্ত।',
    isPublishedOnline: true,
    updatedAt: Date.now(),
  },
  {
    id: 'prod_ordinary',
    name: 'দি অর্ডিনারি নিয়াসিনামাইড ১০% + জিংক ১% সিরাম',
    category: 'স্কিনকেয়ার',
    unit: 'পিস',
    buyPrice: 850,
    salePrice: 1190,
    ...
    stock: 60,
    minStockAlert: 10,
    imageUrl: 'https://images.unsplash.com/photo-1608248597359-54d9c79e6e8e?w=600&auto=format&fit=crop&q=80',
    description: 'কানাডিয়ান ব্র্যান্ড দি অর্ডিনারি অরিজিনাল সিরাম। ত্বকের দাগ দূর করে এবং পোরস ছোট করে ত্বকে আনে সতেজ প্রাকৃতিক উজ্জ্বলতা।',
    isPublishedOnline: true,
    updatedAt: Date.now(),
  },
  {
    id: 'prod_cerave',
    name: 'সেরাভে হাইড্রেটিং ফেসিয়াল ক্লিনজার (২৩৬ মি.লি)',
    category: 'স্কিনকেয়ার',
    unit: 'বোতল',
    buyPrice: 1350,
    salePrice: 1650,
    ...
    description: 'নরমাল থেকে শুষ্ক ত্বকের জন্য সেরা ক্লিনজার। সিরামাইড ও হায়ালুরোনিক অ্যাসিড সমৃদ্ধ, ত্বক রাখে সতেজ ও নরম।',
    isPublishedOnline: true,
    updatedAt: Date.now(),
  },
  {
    id: 'prod_panjabi',
    name: 'প্রিমিয়াম সুতি পাঞ্জাবি (ডিজাইনার কালেকশন)',
    category: 'পাঞ্জাবি',
    unit: 'পিস',
    buyPrice: 1250,
    salePrice: 1850,
    ...
    description: '১০০% খাঁটি সফট কটন আরামদায়ক প্রিমিয়াম পাঞ্জাবি। উৎসব, নামাজ ও দৈনন্দিন ব্যবহারের জন্য নিখুঁত সেলাই ও ফ্যাব্রিক।',
    isPublishedOnline: true,
    updatedAt: Date.now(),
  },
  {
    id: 'prod_shampoo',
    name: 'অর্গানিক টি ট্রি ও রোজমেরি অ্যান্টি-ড্যান্ড্রাফ শ্যাম্পু',
    category: 'স্কিনকেয়ার',
    unit: 'বোতল',
    buyPrice: 620,
    salePrice: 850,
    ...
    stock: 40,
    minStockAlert: 8,
    imageUrl: 'https://images.unsplash.com/photo-1607006314144-88481358dbb7?w=600&auto=format&fit=crop&q=80',
    description: 'খুশকি দূর করতে এবং চুলের গোড়া শক্ত করতে প্রাকৃতিক টি ট্রি অয়েল ও রোজমেরি নির্জাস সমৃদ্ধ শ্যাম্পু।',
    isPublishedOnline: true,
    updatedAt: Date.now(),
  },
  {
    id: 'prod_1',
    name: 'মিনিকেট চাল (প্রিমিয়াম গ্রেড)',
    category: 'চাল ও ডাল',
    unit: 'কেজি',
    buyPrice: 65,
    salePrice: 72,
...
export function getDefaultOnlineStoreConfig(storeName?: string, phone?: string): OnlineStoreConfig {
  ...
  return {
    ...
    minOrderAmount: 0,
    deliveryTimeEstimate: '১২-২৪ ঘণ্টা',
    acceptCOD: true,
    acceptBkash: true,
    bkashNumber: phone || '',
    bkashType: 'merchant',
    ...
    rocketNumber: '',
    rocketType: 'personal',
    paymentInstructions: 'বিকাশ বা নগদে পেমেন্ট করার পর ট্রানজেকশন আইডি প্রদান করুন অথবা ক্যাশ অন ডেলিভারিতে অর্ডার কনফার্ম করুন।',
    bannerStyle: 'neon',
    bannerTitle: 'BEST PICKS OF THE WEEK',
    bannerSubtitle: 'সেরা মানের স্কিনকেয়ার, মেডিসিন ও পাঞ্জাবিতে আকর্ষণীয় ছাড়!',
    bannerTag: 'হট ডিল',
    bannerDiscountText: 'UP TO 55% DISCOUNT',
    bannerUrl: '',
    logoUrl: '',
