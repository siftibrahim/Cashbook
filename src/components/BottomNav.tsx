...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav
      id="bottom-navbar"
      className="w-full bg-white/98 backdrop-blur-md border-t border-slate-200/90 shadow-[0_-4px_20px_rgba(0,0,0,0.06)] px-1 sm:px-2 pt-1 pb-[env(safe-area-inset-bottom,0px)] flex items-center justify-around no-print shrink-0 relative z-30 select-none transition-all"
    >
