...
export const CustomerList: React.FC<CustomerListProps> = ({
  ...
  return (
    <section className="w-full h-full max-h-full bg-white rounded-2xl shadow-xs border border-slate-200/80 flex flex-col no-print relative overflow-hidden">
      {/* Sub-Header: Search, Actions, & Filter Controls (STRICTLY FIXED - never scrolls) */}
      <div className="bg-white p-3.5 sm:p-4 space-y-3 shrink-0 rounded-t-2xl border-b border-slate-100 z-10">
      ...
      {/* Customer List Items (Scrollable Body) */}
      <div className="flex-1 min-h-0 w-full bg-white divide-y divide-slate-100 overflow-y-auto overscroll-contain smooth-scroll-container">
        {filtered.length === 0 ? (
          ...
          <>
            ...
            {(() => {
              ...
              return (
                <div className="p-3.5 sm:p-4 bg-white text-center border-t border-slate-100 space-y-1.5 pb-6 sm:pb-8 rounded-b-2xl">
